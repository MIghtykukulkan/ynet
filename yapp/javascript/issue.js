...
async function issue(issuerId, productID,  companyId, org) {
    try {
        ...
        var d = new Date();
        let resp = await contract.submitTransaction('issueProduct', issuerId , companyId, productID , d.toDateString());
